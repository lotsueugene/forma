...
export default function NewFormPage() {
  ...
  const handleSave = async (status: 'draft' | 'active' = 'draft') => {
    ...
    try {
      ...
      // Show publish modal or redirect
      if (status === 'active') {
        setPublishedFormId(data.form.id);
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col -mx-4 -mb-4 lg:-mx-6 lg:-mb-6">
                    ...
                    <div className="space-y-3">
                      <div className="form-field">
                        ...
                        <ColorPicker
                          ...
                          onChange={(v) => setFormSettings({ ...formSettings, branding: { ...formSettings.branding, accentColor: v } })}
                        />
                      </div>
                      <div className="form-field">
                        ...
                        <ColorPicker
                          ...
                          onChange={(v) => setFormSettings({ ...formSettings, branding: { ...formSettings.branding, backgroundColor: v } })}
                        />
                      </div>
                      <div className="form-field">
                        ...
                        <ColorPicker
                          ...
                          onChange={(v) => setFormSettings({ ...formSettings, branding: { ...formSettings.branding, textColor: v } })}
                        />
                      </div>
      ...
      <AnimatePresence>
        {showPublishModal && publishedFormId && (
          <>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              onClick={() => { setShowPublishModal(false); router.push(`/dashboard/forms/${publishedFormId}`); }}
            />
            <motion.div
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="text"
                      readOnly
                      value={`${typeof window !== 'undefined' ? window.location.origin : ''}/f/${publishedFormId}`}
