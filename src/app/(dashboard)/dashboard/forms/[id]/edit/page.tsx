  ...
  useEffect(() => {
    const fetchForm = async () => {
      try {
        ...
        // Parse settings
        if (form.settings) {
          const parsedSettings = typeof form.settings === 'string'
  ...
  if (isLoading) {
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center">
        <div className="w-8 h-8 border-2 border-gray-300 border-t-safety-orange rounded-full animate-spin" />
      </div>
    );
  }
                ...
                {selectedField.type === 'hidden' && (
                  <div className="form-field">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Use <code className="bg-gray-100 px-1 rounded">{'{{param}}'}</code> to capture URL parameters (e.g. <code className="bg-gray-100 px-1 rounded">{'{{utm_source}}'}</code>)
                    </p>
                  </div>
                )}
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      {formSettings.branding?.accentColor && (
                        <button
                          onClick={() => setFormSettings({ ...formSettings, branding: undefined })}
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <div className="space-y-3">
                      <div className="form-field">
                        ...
                        <input
                          type="text"
                          value={formSettings.thankYou?.heading || ''}
                          onChange={(e) => setFormSettings({
                            ...formSettings,
                            thankYou: { ...formSettings.thankYou, heading: e.target.value },
                          })}
                          className="input"
                      ...
                      <div className="form-field">
                        ...
                        <textarea
                          value={formSettings.thankYou?.message || ''}
                          onChange={(e) => setFormSettings({
                            ...formSettings,
                            thankYou: { ...formSettings.thankYou, message: e.target.value },
                          })}
                      ...
                      <div className="form-field">
                        ...
                        <input
                          type="url"
                          value={formSettings.thankYou?.redirectUrl || ''}
                          onChange={(e) => setFormSettings({
                            ...formSettings,
                            thankYou: { ...formSettings.thankYou, redirectUrl: e.target.value },
                          })}
                          className="input"
                      ...
                      <div className="flex items-center justify-between py-2">
                        ...
                        <button
                          ...
                          onClick={() => setFormSettings({
                            ...formSettings,
                            thankYou: {
                              ...formSettings.thankYou,
                              showBranding: formSettings.thankYou?.showBranding === false ? true : false,
                            },
                          })}
                          className={cn(
                            'w-11 h-6 rounded-full transition-colors relative',
                        ...
                        >
                          <div
                            className={cn(
                              'w-5 h-5 rounded-full bg-white absolute top-0.5 transition-transform shadow',
                              formSettings.thankYou?.showBranding !== false ? 'translate-x-5' : 'translate-x-0.5'
                            )}
                          />
                        </button>
                      </div>
